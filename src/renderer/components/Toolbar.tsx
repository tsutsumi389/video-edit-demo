...
export function Toolbar({ isPlaying, currentTime, totalDuration, onTogglePlayPause }: ToolbarProps) {
  ...
  return (
    <div className="toolbar">
      ...
      <div className="toolbar-center">
        <button className="toolbar-btn play-btn" onClick={onTogglePlayPause} disabled={!hasClips}>
